    ...
    def get_nameid_persistent(cls, user_id, sp_entityid="", idp_entityid="", user=None):
        ...
        if user and not pid:
            ...
            user_persistent_id = cls.get_nameid_opaque(
                cls.get_nameid_prefix(user_id, sp_entityid, idp_entityid, user),
...
class BaseProcessor:
    ...
    def get_user_id(self, user, sp, idp_config):
        """Get identifier for a user. For Nextcloud, this is *always* the original email"""
        user_field_str = "original_email"
    ...
    def extra_attr_processing(self, results, sp_mapping, **kwargs):
        """This should inherit another class
    ...
    def create_identity(self, user, sp={}):
        ...
        sp_mapping = {
            ...
            "eduPersonPrincipalName": "original_email",
        }
